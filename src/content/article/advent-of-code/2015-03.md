...
This should be easier to implement into our current code. We just need to track one more character and move them in turns. A simple modulo operator should be enough for checking turns.
...
This works as expected and second part of the puzzle is now solved, but I am leaving this puzzle a bit unsatisfied because I feel like I partly cheated my way through it, because I can't say I completely get how traits are working here. I kind of get it, but I also don't... I should try and write a post about it.
